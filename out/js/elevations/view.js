...
elevations.view.xy = cljs.core.juxt.call(null,(function (p1__99557_SHARP_){
return p1__99557_SHARP_.x;
}),(function (p1__99558_SHARP_){
return p1__99558_SHARP_.y;
}));
...
return (function (p1__99562_SHARP_){
return Math.abs((ms - new cljs.core.Keyword(null,"time","time",1385887882).cljs$core$IFn$_invoke$arity$1(p1__99562_SHARP_).getTime()));
});})(ms))
;
...
elevations.view.size = cljs.core.juxt.call(null,(function (p1__99563_SHARP_){
return p1__99563_SHARP_.offsetWidth;
}),(function (p1__99564_SHARP_){
return p1__99564_SHARP_.offsetHeight;
}));
...
return (function (p__99573){
var map__99574 = p__99573;
var map__99574__$1 = ((cljs.core.seq_QMARK_.call(null,map__99574))?cljs.core.apply.call(null,cljs.core.hash_map,map__99574):map__99574);
var scrub = cljs.core.get.call(null,map__99574__$1,new cljs.core.Keyword(null,"scrub","scrub",759182926));
var show_QMARK_ = cljs.core.get.call(null,map__99574__$1,new cljs.core.Keyword(null,"show?","show?",1543842127));
var geojson = cljs.core.get.call(null,map__99574__$1,new cljs.core.Keyword(null,"geojson","geojson",-719473398));
var map_pane = cljs.core.get.call(null,map__99574__$1,new cljs.core.Keyword(null,"map-pane","map-pane",-450448112));
...
var proj = ((function (map__99574,map__99574__$1,scrub,show_QMARK_,geojson,map_pane,map_section){
return (function (p__99578){
var vec__99579 = p__99578;
var lon = cljs.core.nth.call(null,vec__99579,(0),null);
var lat = cljs.core.nth.call(null,vec__99579,(1),null);
return elevations.view.xy.call(null,map_pane.latLngToLayerPoint((new L.LatLng(lat,lon))));
});})(map__99574,map__99574__$1,scrub,show_QMARK_,geojson,map_pane,map_section))
;
var path = d3.geo.path().projection(cljs.core.comp.call(null,cljs.core.clj__GT_js,proj));
var vec__99575 = d3.geo.bounds(geojson);
var bottom_left = cljs.core.nth.call(null,vec__99575,(0),null);
var top_right = cljs.core.nth.call(null,vec__99575,(1),null);
var vec__99576 = proj.call(null,bottom_left);
var x1 = cljs.core.nth.call(null,vec__99576,(0),null);
var y2 = cljs.core.nth.call(null,vec__99576,(1),null);
var vec__99577 = proj.call(null,top_right);
var x2 = cljs.core.nth.call(null,vec__99577,(0),null);
var y1 = cljs.core.nth.call(null,vec__99577,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"svg","svg",856789142),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),"leaflet-svg",new cljs.core.Keyword(null,"width","width",-384071477),elevations.view.margin.call(null,(2),cljs.core._PLUS_,(x2 - x1)),new cljs.core.Keyword(null,"height","height",1025178622),elevations.view.margin.call(null,(2),cljs.core._PLUS_,(y2 - y1)),new cljs.core.Keyword(null,"style","style",-496642736),{"margin-top": [cljs.core.str(elevations.view.margin.call(null,cljs.core._,y1)),cljs.core.str("px")].join(''), "margin-left": [cljs.core.str(elevations.view.margin.call(null,cljs.core._,x1)),cljs.core.str("px")].join('')}], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"g","g",1738089905),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),"map-pane",new cljs.core.Keyword(null,"class","class",-2030961996),"leaflet-zoom-hide",new cljs.core.Keyword(null,"transform","transform",1381301764),[cljs.core.str("translate("),cljs.core.str(elevations.view.margin.call(null,cljs.core._PLUS_,(- x1))),cljs.core.str(","),cljs.core.str(elevations.view.margin.call(null,cljs.core._PLUS_,(- y1))),cljs.core.str(")")].join('')], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"path","path",-188191168),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",-1388402092),"path",new cljs.core.Keyword(null,"d","d",1972142424),path.call(null,geojson)], null)], null),(cljs.core.truth_(scrub)?(function (){var vec__99580 = proj.call(null,elevations.view.lon_lat.call(null,new cljs.core.Keyword(null,"point","point",1813198264).cljs$core$IFn$_invoke$arity$1(scrub)));
var x = cljs.core.nth.call(null,vec__99580,(0),null);
var y = cljs.core.nth.call(null,vec__99580,(1),null);
...
elevations.view.elevations = (function elevations$view$elevations(p__99581,actions){
var map__99594 = p__99581;
var map__99594__$1 = ((cljs.core.seq_QMARK_.call(null,map__99594))?cljs.core.apply.call(null,cljs.core.hash_map,map__99594):map__99594);
var scrub = cljs.core.get.call(null,map__99594__$1,new cljs.core.Keyword(null,"scrub","scrub",759182926));
var map__99595 = cljs.core.get.call(null,map__99594__$1,new cljs.core.Keyword(null,"selected","selected",574897764));
var map__99595__$1 = ((cljs.core.seq_QMARK_.call(null,map__99595))?cljs.core.apply.call(null,cljs.core.hash_map,map__99595):map__99595);
var selected = map__99595__$1;
var points = cljs.core.get.call(null,map__99595__$1,new cljs.core.Keyword(null,"points","points",-1486596883));
var started = cljs.core.get.call(null,map__99595__$1,new cljs.core.Keyword(null,"started","started",585705024));
...
var vec__99596 = elevations.view.size.call(null,svg);
var width = cljs.core.nth.call(null,vec__99596,(0),null);
var height = cljs.core.nth.call(null,vec__99596,(1),null);
var vec__99597 = elevations.util.extrema.call(null,new cljs.core.Keyword(null,"elevation","elevation",-1609348796),points);
var lowest = cljs.core.nth.call(null,vec__99597,(0),null);
var highest = cljs.core.nth.call(null,vec__99597,(1),null);
var exts = vec__99597;
...
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"g","g",1738089905),cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4951__auto__ = ((function (padding,side,svg,vec__99596,width,height,vec__99597,lowest,highest,exts,x,y,inner_height,sx,map__99594,map__99594__$1,scrub,map__99595,map__99595__$1,selected,points,started){
return (function elevations$view$elevations_$_iter__99598(s__99599){
return (new cljs.core.LazySeq(null,((function (padding,side,svg,vec__99596,width,height,vec__99597,lowest,highest,exts,x,y,inner_height,sx,map__99594,map__99594__$1,scrub,map__99595,map__99595__$1,selected,points,started){
return (function (){
var s__99599__$1 = s__99599;
while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__99599__$1);
if(temp__4126__auto__){
var s__99599__$2 = temp__4126__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__99599__$2)){
var c__4949__auto__ = cljs.core.chunk_first.call(null,s__99599__$2);
var size__4950__auto__ = cljs.core.count.call(null,c__4949__auto__);
var b__99601 = cljs.core.chunk_buffer.call(null,size__4950__auto__);
if((function (){var i__99600 = (0);
while(true){
if((i__99600 < size__4950__auto__)){
var map__99604 = cljs.core._nth.call(null,c__4949__auto__,i__99600);
var map__99604__$1 = ((cljs.core.seq_QMARK_.call(null,map__99604))?cljs.core.apply.call(null,cljs.core.hash_map,map__99604):map__99604);
var t = cljs.core.get.call(null,map__99604__$1,new cljs.core.Keyword(null,"time","time",1385887882));
var elev = cljs.core.get.call(null,map__99604__$1,new cljs.core.Keyword(null,"elevation","elevation",-1609348796));
cljs.core.chunk_append.call(null,b__99601,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"g","g",1738089905),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),"extreme",new cljs.core.Keyword(null,"transform","transform",1381301764),[cljs.core.str("translate(0,"),cljs.core.str(y.call(null,elev)),cljs.core.str(")")].join('')], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),"tick",new cljs.core.Keyword(null,"x1","x1",-1863922247),x.call(null,started),new cljs.core.Keyword(null,"x2","x2",-1362513475),x.call(null,t)], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"text","text",-1790561697),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"dx","dx",-381796732),(18),new cljs.core.Keyword(null,"dy","dy",1719547243),(5)], null),[cljs.core.str(Math.round(elev)),cljs.core.str("'")].join('')], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"circle","circle",1903212362),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"cx","cx",1272694324),x.call(null,t),new cljs.core.Keyword(null,"r","r",-471384190),(3)], null)], null)], null));

var G__99606 = (i__99600 + (1));
i__99600 = G__99606;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__99601),elevations$view$elevations_$_iter__99598.call(null,cljs.core.chunk_rest.call(null,s__99599__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__99601),null);
}
} else {
var map__99605 = cljs.core.first.call(null,s__99599__$2);
var map__99605__$1 = ((cljs.core.seq_QMARK_.call(null,map__99605))?cljs.core.apply.call(null,cljs.core.hash_map,map__99605):map__99605);
var t = cljs.core.get.call(null,map__99605__$1,new cljs.core.Keyword(null,"time","time",1385887882));
var elev = cljs.core.get.call(null,map__99605__$1,new cljs.core.Keyword(null,"elevation","elevation",-1609348796));
return cljs.core.cons.call(null,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"g","g",1738089905),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),"extreme",new cljs.core.Keyword(null,"transform","transform",1381301764),[cljs.core.str("translate(0,"),cljs.core.str(y.call(null,elev)),cljs.core.str(")")].join('')], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),"tick",new cljs.core.Keyword(null,"x1","x1",-1863922247),x.call(null,started),new cljs.core.Keyword(null,"x2","x2",-1362513475),x.call(null,t)], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"text","text",-1790561697),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"dx","dx",-381796732),(18),new cljs.core.Keyword(null,"dy","dy",1719547243),(5)], null),[cljs.core.str(Math.round(elev)),cljs.core.str("'")].join('')], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"circle","circle",1903212362),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"cx","cx",1272694324),x.call(null,t),new cljs.core.Keyword(null,"r","r",-471384190),(3)], null)], null)], null),elevations$view$elevations_$_iter__99598.call(null,cljs.core.rest.call(null,s__99599__$2)));
}
} else {
return null;
}
...
});})(padding,side,svg,vec__99596,width,height,vec__99597,lowest,highest,exts,x,y,inner_height,sx,map__99594,map__99594__$1,scrub,map__99595,map__99595__$1,selected,points,started))
,null,null));
});})(padding,side,svg,vec__99596,width,height,vec__99597,lowest,highest,exts,x,y,inner_height,sx,map__99594,map__99594__$1,scrub,map__99595,map__99595__$1,selected,points,started))
;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__99618),elevations$view$main_$_iter__99615.call(null,cljs.core.chunk_rest.call(null,s__99616__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__99618),null);
}
} else {
var track = cljs.core.first.call(null,s__99616__$2);
return cljs.core.cons.call(null,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"className","className",-1983287057),elevations.util.classes.call(null,"track",((cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(selected),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(track)))?"selected":null)),new cljs.core.Keyword(null,"onclick","onclick",1297553739),vdom.elm.event.call(null,actions,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"select","select",1147833503),track], null))], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"className","className",-1983287057),"date"], null),elevations.util.format_date.call(null,new cljs.core.Keyword(null,"started","started",585705024).cljs$core$IFn$_invoke$arity$1(track))], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"className","className",-1983287057),"length muted"], null),elevations.util.format_duration.call(null,new cljs.core.Keyword(null,"duration","duration",1444101068).cljs$core$IFn$_invoke$arity$1(track))], null)], null),elevations$view$main_$_iter__99615.call(null,cljs.core.rest.call(null,s__99616__$2)));
}
} else {
return null;
}
...
});})(map__99614,map__99614__$1,model,selected,tracks,droppable_QMARK_))
,null,null));
});})(map__99614,map__99614__$1,model,selected,tracks,droppable_QMARK_))
;
